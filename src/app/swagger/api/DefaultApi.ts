...
export class DefaultApi {
     ...
     * 
     */
    public get(extraHttpRequestParams?: any): Observable<{}> {
     ...
     */
    public post(payload?: models.Payload, extraHttpRequestParams?: any): Observable<{}> {
        return this.postWithHttpInfo(payload, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param payload Request Body
     */
    public postWithHttpInfo(payload?: models.Payload, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/*`;
